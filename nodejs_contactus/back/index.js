...
const rosterDB = [
    {
        ...
        message: "Sana Hesus Ay Biyernes na Uli",
    },
    {
        fullName: "Chris Martin",
        Email: "chris@yahoo.com",
        message: "Were gonna get it, up and up and up!",
    },
];
...
app.post('/rosterDB', (req, res)=>{
    ...
    const message = req.body.message;
        ...
        rosterDB.push(newRecord);
        res.status(200).json({ code: "success", msg: "Save record successfully", rosterDB });
    });
...
app.post('/add', (req, res)=>{
    ...
    idCoount = profileDB.length + 1;
    const newRecord = {                 //adding new record sa database
        id: idCoount,
        firstname: firstname,
        lastname: lastname,
        phone: phone,
